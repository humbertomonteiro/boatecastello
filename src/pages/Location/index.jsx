      ...
      <div className="location">
        ...
        <div data-aos="fade-up" className="location-text">
          ...
          <p>
            ...
            vero cumque numquam blanditiis consectetur quo atque praesentium,
            nemo ipsam ducimus velit accusamus, commodi quisquam, minus
            molestias dolorem aliquam quia suscipit!
          </p>
          <a
